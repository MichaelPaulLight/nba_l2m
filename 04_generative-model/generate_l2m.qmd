...
simulate_complete_game <- function(game_id) {
...
# Simulate all games
sim_data <- do.call(rbind, lapply(1:n_games, simulate_complete_game))
```

Here we'll look at the 2015 season to inform our base rates for a similar simulation that generates last two minute reports
...
Code to simulate last 2 minute report data
```{r}
